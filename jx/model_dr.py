...
class DR_JXCGWCRXX(Base):
    __tablename__ = 'dr_jxcgwcrxx'
...
class DR_JXHJXX(Base):
    __tablename__ = 'dr_jxhjxx'
...
class DR_DXSKJXMJBSJXX(Base):
    __tablename__ = 'dr_dxskjxmjbsjxx'
...
class DR_YJSDSPYGX(Base):
    __tablename__ = 'dr_yjsdspygx'
